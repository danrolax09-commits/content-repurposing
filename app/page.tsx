    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800">
      <header className="border-b border-slate-700">
        <div className="max-w-7xl mx-auto px-4 py-6 flex justify-between items-center">
          <h1 className="text-3xl font-bold text-white">🎯 Content Repurposing</h1>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20 text-center">
        <h2 className="text-5xl font-bold text-white mb-6">Turn One Piece of Content Into Dozens</h2>
        <p className="text-xl text-slate-400 mb-8 max-w-2xl mx-auto">Automatically repurpose your blog posts, videos, and articles into social media content, email, and more.</p>
        <button
